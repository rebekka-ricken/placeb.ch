...
import { Component, Renderer, ElementRef, EventEmitter } from 'angular2/core';
 ...
 * ```
 */
export let SebmGoogleMap = class {
    constructor(_elem, _mapsWrapper, _renderer) {
        this._elem = _elem;
    ...
    _initMapInstance(el) {
        this._mapsWrapper.createMap(el, { center: { lat: this._latitude, lng: this._longitude }, zoom: this._zoom });
        this._handleMapCenterChange();
        this._handleMapZoomChange();
        this._handleMapMouseEvents();
    }
    static _containsMapOptionsChange(changesKeys) {
        return changesKeys.every((key) => { return SebmGoogleMap._mapOptionsAttributes.indexOf(key) !== 1; });
    }
    /** @internal */
    ngOnChanges(changes) {
    ...
    _handleMapZoomChange() {
        this._mapsWrapper.subscribeToMapEvent('zoom_changed')
            .subscribe(() => { this._mapsWrapper.getZoom().then((z) => this._zoom = z); });
    }
    _handleMapMouseEvents() {
        ...
        events.forEach((e) => {
            this._mapsWrapper.subscribeToMapEvent(e.name)
                .subscribe((event) => {
...
SebmGoogleMap = __decorate([
  ...
  `
    ...
    __metadata('design:paramtypes', [(typeof (_a = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _a) || Object, GoogleMapsAPIWrapper, (typeof (_b = typeof Renderer !== 'undefined' && Renderer) === 'function' && _b) || Object])
], SebmGoogleMap);
var _a, _b;
