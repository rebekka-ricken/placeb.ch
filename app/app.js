        ...
        execute: function() {
            App = (function (_super) {
                ...
                App = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, params_service_1.ParamsService, token_service_1.Token, user_service_1.UserService, http_wrapper_service_1.httpWrap, animation_builder_1.AnimationBuilder])
                ], App);
                return App;
