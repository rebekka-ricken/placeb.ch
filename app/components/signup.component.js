    ...
    return {
        ...
        execute: function() {
            SignupComponent = (function (_super) {
                ...
                function SignupComponent(tokenHandler, _signup, router, paramsService, broadcaster, termsServ, userService, fb, ab, loginHandler) {
                ...
                SignupComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [token_service_1.Token, signup_service_1.Signup, router_1.Router, params_service_1.ParamsService, broadcaster_1.Broadcaster, terms_service_1.TermsService, user_service_1.UserService, common_1.FormBuilder, animation_builder_1.AnimationBuilder, login_service_1.Login])
                ], SignupComponent);
