System.register(['angular2/core', "../pipes/localization.pipe", "./base.component", "angular2/router", "../services/user.service", "angular2/src/animate/animation_builder", "../services/common/token.service"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            InfoPopupComponent = (function (_super) {
                __extends(InfoPopupComponent, _super);
                function InfoPopupComponent(tokenHandler, router, userService, ab, translator, location) {
                ...
                ], InfoPopupComponent.prototype, "open", void 0);
                __decorate([
                    core_1.Output(), 
                    __metadata('design:type', Object)
                ], InfoPopupComponent.prototype, "toggle", void 0);
                InfoPopupComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [token_service_1.Token, router_1.Router, user_service_1.UserService, animation_builder_1.AnimationBuilder, localization_pipe_1.LocalizePipe, router_1.Location])
                ], InfoPopupComponent);
                return InfoPopupComponent;
            }(base_component_1.BaseComponent));
            exports_1("InfoPopupComponent", InfoPopupComponent);
        }
    }
});
//# sourceMappingURL=info-popup.component.js.map