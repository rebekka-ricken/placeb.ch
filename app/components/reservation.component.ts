...
export class ReservationComponent extends BaseComponent implements OnInit {
    ...
    constructor(router:Router, userService:UserService, tokenHandler:Token, private builder:FormBuilder, public ab:AnimationBuilder, public translator:LocalizePipe) {
