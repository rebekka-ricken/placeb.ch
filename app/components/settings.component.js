System.register(['angular2/core', 'angular2/router', '../services/user.service', '../services/common/token.service', "./base.component", 'angular2/src/animate/animation_builder', "../pipes/localization.pipe"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, user_service_1, token_service_1, router_2, base_component_1, animation_builder_1, localization_pipe_1;
    ...
    return {
        ...
        execute: function() {
            SettingsComponent = (function (_super) {
                ...
                function SettingsComponent(userService, tokenHandler, router, ab, translator, location) {
                    var _this = this;
                ...
                SettingsComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [user_service_1.UserService, token_service_1.Token, router_2.Router, animation_builder_1.AnimationBuilder, localization_pipe_1.LocalizePipe, router_1.Location])
                ], SettingsComponent);
