    ...
    return {
        ...
        execute: function() {
            BaseComponent = (function () {
                function BaseComponent(router, userService, tokenHandler, ab) {
                    this.router = router;
                ...
                BaseComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, user_service_1.UserService, token_service_1.Token, animation_builder_1.AnimationBuilder])
                ], BaseComponent);
