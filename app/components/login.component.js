    ...
    return {
        ...
        execute: function() {
            LoginComponent = (function (_super) {
                ...
                function LoginComponent(tokenHandler, loginHandler, router, userService, ab, http, translator) {
                ...
                LoginComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [token_service_1.Token, login_service_1.Login, router_1.Router, user_service_1.UserService, animation_builder_1.AnimationBuilder, http_wrapper_service_1.httpWrap, localization_pipe_1.LocalizePipe])
                ], LoginComponent);
