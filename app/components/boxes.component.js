System.register(['angular2/core', 'angular2/src/animate/animation_builder', '../services/common/scroller.service', '../services/common/token.service', 'angular2/router', '../services/user.service', '../pipes/filter.pipe', '../pipes/amount.pipe', '../pipes/customCurrency.pipe', "./base.component", "../pipes/boxSize.pipe", "../pipes/localization.pipe"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, animation_builder_1, scroller_service_1, token_service_1, router_1, user_service_1, filter_pipe_1, amount_pipe_1, customCurrency_pipe_1, base_component_1, boxSize_pipe_1, localization_pipe_1;
    var BoxesComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            BoxesComponent = (function (_super) {
                ...
                function BoxesComponent(ab, router, userService, tokenHandler) {
                    var _this = this;
                ...
                BoxesComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [animation_builder_1.AnimationBuilder, router_1.Router, user_service_1.UserService, token_service_1.Token])
                ], BoxesComponent);
