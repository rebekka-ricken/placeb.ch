    ...
    return {
        ...
        execute: function() {
            MapComponent = (function (_super) {
                ...
                function MapComponent(_locationsService, _boxService, _loginService, _categoriesService, _token, _us, router, ab, location) {
                    _super.call(this, router, _us, _token, ab, location);
                ...
                MapComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [locations_service_1.LocationsService, box_service_1.BoxService, login_service_1.Login, categories_service_1.CategoriesService, token_service_1.Token, user_service_1.UserService, router_1.Router, animation_builder_1.AnimationBuilder, router_1.Location])
                ], MapComponent);
                return MapComponent;
