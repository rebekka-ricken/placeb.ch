System.register(['./base.service', 'angular2/core', './common/token.service', './auth/login.service', './common/http-wrapper.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            CategoriesService = (function (_super) {
                ...
                CategoriesService.prototype.getCategories = function (id) {
                    return this.http.get("" + this.baseUrl + this.locationsSuffix + "/" + id + this.categoriesSuffix);
                };
